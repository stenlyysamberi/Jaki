            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="text-lg-right mt-3 mt-lg-0">
                        ...
                        <a data-toggle="modal" data-target="#venue-modal" href="#" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle mr-1"></i>New Venue</a>
                    </div>
                </div><!-- end col-->
            </div> <!-- end row -->
        </div> <!-- end card-box -->
...
<div id="venue-modal" class="modal fade wisata-model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Info Venue</h4>
            ...
            <div class="modal-body p-4">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="field-1" class="control-label">Nama Venue</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="simpan_venue btn btn-success waves-effect waves-light">Simpan</button>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Stenly\Documents\WebApp\jaki\resources\views/pages/venue.blade.php ENDPATH**/ ?>
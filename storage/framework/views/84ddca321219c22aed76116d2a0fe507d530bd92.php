                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo e(auth()->user()->nama); ?>" disabled class="form-control tlpn_dest" id="field-2" placeholder="Doe">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('main.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Stenly\Documents\WebApp\jaki\resources\views/pages/news.blade.php ENDPATH**/ ?>
                            ...
                            <div class="card-body p-4">
                                ...
                                <?php if(session('masuk')): ?>
                                    <div class="alert alert-danger" role="alert">
                                        <i class=" mr-2"></i>  <?php echo e(session('masuk')); ?>
                                ...
                                <form action="/login" method="POST">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input autofocus  class="form-control mb-1 <?php $__errorArgs = ['hp'];
...
unset($__errorArgs, $__bag); ?>" type="number" name="hp" value="<?php echo e(old('hp')); ?>" required  placeholder="Phone">
                                        <?php $__errorArgs = ['hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
</html><?php /**PATH C:\Users\Stenly\Documents\WebApp\jaki\resources\views/auth/login.blade.php ENDPATH**/ ?>